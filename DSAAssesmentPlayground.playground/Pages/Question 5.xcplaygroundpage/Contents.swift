...
func findBadCommit(input:[Commit]) -> String {
    var firstBadCommit: Commit!
    ...
    print(firstBadCommit.timestamp.description)
    
    return firstBadCommit.timestamp.description
}

findBadCommit(input: input)
